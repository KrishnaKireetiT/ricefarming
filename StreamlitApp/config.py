...
# ADITI Pipeline uses its own multilingual model internally

# ========================================
# K-GraphRAG Dense Embedding Model (OpenAI-compatible)
# ========================================
EMBED_MODEL = os.getenv("EMBED_MODEL", "text-embedding-3-small")

# ========================================
# ColBERT Embedding Config
# ========================================
COLBERT_EMBED_BASE = os.getenv("COLBERT_EMBED_BASE", str(APP_DIR.parent.parent.parent / "FinalizedPpipelines" / "colbert-embeddings"))
